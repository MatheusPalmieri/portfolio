...
export const Header = () => {
  ...
  return (
    <header id="home" className="h-[100dvh] bg-zinc-900">
      <Stack className="h-full gap-6 justify-center items-center relative">
        ...
        <div className="flex flex-col items-center gap-3">
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-wider">
            Hi, I'm Matheus {!isMobile && "Palmieri"}
          </h2>
          <p className="text-md md:text-xl font-medium">
            An{" "}
            <span className="text-zinc-300 font-bold">Software Engineer</span>{" "}
            from Brazil
          </p>
        </div>
      ...
      <div className="absolute bottom-6 md:bottom-12 left-[50%] translate-x-[-50%]">
        <a
          href="#projects"
